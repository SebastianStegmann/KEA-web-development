...
if (_check_role('admin') && isset($_GET['user']) == null && strpos($_SERVER['REQUEST_URI'], '/profile') === true) {
  header('Location: /admin');
  exit();
}
if (!_check_role('admin') && isset($_GET['user']) && strpos($_SERVER['REQUEST_URI'], '/profile') === true) {
...
if (isset($_GET['role'])) {
  switch ($_GET['role']) {
    case 1:
      $_SESSION['user']['user_role_name'] = 'admin';
      break;
    case 2:
      $_SESSION['user']['user_role_name'] = 'partner';
      break;
    case 3:
      $_SESSION['user']['user_role_name'] = 'customer';
      break;
    case 4:
      $_SESSION['user']['user_role_name'] = 'employee';
      break;
    default:
      # code...
      break;
